...
def execute(
    ...
    to_use_extractors = [dataset_extractors[dset.value] for dset in dsets]

    dset = prepare_dataset(to_use_extractors, cache_dir, langs, content_column)
    if seed is not None:
