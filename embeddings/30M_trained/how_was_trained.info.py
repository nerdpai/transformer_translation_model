...
## hidden
__DATASET_NUM_OF_LINES: int = 30 * 10**6
...
## tokenizer
tokenizer_path = Path("./vocabs/large/all/tokenizer.json")
...
c4_sizes: list[int] = [12 * 10**6, 9 * 10**6, 9 * 10**6]
...
## train_embedding
embedding_dir = Path("./all_large_emb")
